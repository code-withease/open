...
/**
 * @file
 * Defines Javascript behaviors for the hubber_customers module.
 */

(function ($, Drupal) {
  'use strict';

  Drupal.behaviors.hubberCustomers = {
    attach: function (context, settings) {
      $('.js-change-mail-email', context).bind('copy paste cut',function(e) {
        e.preventDefault(); //this line will help us to disable cut,copy,paste
      });

      $('.js-change-mail-confirm-email', context).bind('copy paste cut',function(e) {
        e.preventDefault(); //this line will help us to disable cut,copy,paste
      });

      $('.block-social-auth-login .login-social-list a.btn', context).on('click', function() {
        var $input_email = $('input[name="name"]');
        if ($input_email.length > 0 && $input_email.val() === '') {
          $input_email.removeClass('required');
          $input_email.removeClass('js-invalid');
