...
(function ($) {
  ...
  Drupal.behaviors.rwc_edito = {
    attach: function (context) {

      if ($('.page-donation .block-cross-selling').length) {
        $('.page-donation .block-cross-selling').appendTo('.page-donation .cross-selling-placeholder');

        $('.page-donation .block-cross-selling .internal-products').on('init', function (event, slick) {
          setTimeout(function() {
            $('.page-donation .block-cross-selling .internal-products').slick('unslick');
          }, 100);
        });
      }
      ...
      $('.question_ww').once('question_ww_click').on('click', function() {
        $(this).next('.answer_ww').slideToggle();
      });

      $('.onglet_ww').wrapAll('<div class="onglets_ww"></div>');
      $('.onglets_ww').after('<div class="content_onglet"></div>');

      $('.onglet_ww.head').once('onglet_ww_head_click').on('click', function() {
        if ($('.onglet_ww.head').hasClass('active')) {
          $('.onglet_ww.head').removeClass('active');
          $('.onglet_ww.head').next('.col_onglet').removeClass('active');
          $('.content_onglet').empty().text();
          $(this).addClass('active');
          $(this).next('.col_onglet').addClass('active');
          $('.content_onglet').append($('.col_onglet.active').html());
      ...
      $('.dashboard_style').wrapAll('<div class="dashboard_style_content"></div>');
