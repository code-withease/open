  ...
  (function ($, Drupal) {
    ...
    Drupal.behaviors.nextEventsRwc = {
      ...
      attach: function (context) {
        ...
        $('.list-ticket-content .modal-content-wrapper').each(function() {
          if ($(this).find('.btn-main-sale:disabled').length && $(this).find('.btn-resale.unavailable').length) {
            $(this).closest('.actions-wrapper').find('.js-show-offers').html(Drupal.t('Unavailable')).addClass('unavailable').removeClass('js-show-offers').off('click');
          }
        });
